 ...
 * 
 */
public class SendConfigRestTest_online {
	private final String BASE_URL = "http://www.gs10086edu.com:70/TSB_ISCHOOL_MOOC_SERVER";//正式环境短信地址
	
	//测试发验证码
	@Test
	public void sendmess() throws Exception {
		String requestUrl = BASE_URL + "/sendmsg/send";
			sendRequest(requestUrl, "POST","{\"phonenumber\":\"15101221992\",\"messagetype\":\"2\"}");
	}
	
	//测试发短信内容
	@Test
	public void sendmess2() throws Exception {
		String requestUrl = BASE_URL + "/sendmsg/send";
			sendRequest(requestUrl, "POST","{\"phonenumber\":\"15101221992\",\"messagetype\":\"1\",\"messagecontent\":\"[作业]李欣依姌:练习册22、23页做完。（请家长指导检查）试卷一份做完。（请批阅打分）;[路芝梅★★]\"}");
	}
