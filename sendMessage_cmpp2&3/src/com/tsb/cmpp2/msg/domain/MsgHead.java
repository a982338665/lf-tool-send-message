...
public class MsgHead {
	...
	private int totalLength;//Unsigned Integer 字节数：4 ，消息总长度
	private int commandId;//Unsigned Integer 字节数：4 ，命令或响应类型
	private int sequenceId;//Unsigned Integer 字节数：4 ，消息流水号,顺序累加,步长为1,循环使用（一对请求和应答消息的流水号必须相同）
