...
public interface MsgCommand {
	...
	int CMPP_MT_ROUTE = 0x00000010;// MT路由请求
	int CMPP_MT_ROUTE_RESP = 0x80000010; // MT路由请求应答
	int CMPP_MO_ROUTE = 0x00000011; // MO路由请求
	int CMPP_MO_ROUTE_RESP = 0x80000011;// MO路由请求应答
	int CMPP_GET_ROUTE = 0x00000012;// 获取路由请求
	int CMPP_GET_ROUTE_RESP = 0x80000012;// 获取路由请求应答
	int CMPP_MT_ROUTE_UPDATE = 0x00000013;// MT路由更新
	int CMPP_MT_ROUTE_UPDATE_RESP = 0x80000013;// MT路由更新应答
	int CMPP_MO_ROUTE_UPDATE = 0x00000014;// MO路由更新
	int CMPP_MO_ROUTE_UPDATE_RESP = 0x80000014;// MO路由更新应答
	int CMPP_PUSH_MT_ROUTE_UPDATE = 0x00000015;// MT路由更新
	int CMPP_PUSH_MT_ROUTE_UPDATE_RESP = 0x80000015;// MT路由更新应答
	int CMPP_PUSH_MO_ROUTE_UPDATE = 0x00000016;// MO路由更新
	int CMPP_PUSH_MO_ROUTE_UPDATE_RESP = 0x80000016;// MO路由更新应答
